...
function wp_nav_menu_objects( $items, $args ) {
	...
	$stickyheader = wp_theme_legacy_menu_acf_get( 'sticky_header', $menu );
	...
	$megamenu = wp_theme_legacy_menu_acf_get( 'mega_menu', $menu );
	if ( $megamenu == 'true' ):
	...
	$lastnavbtn = wp_theme_legacy_menu_acf_get( 'last_button', $menu );
	if ( $lastnavbtn == 'true' ):
	...
	// Search - searchbox
	$search = wp_theme_legacy_menu_acf_get( 'search_bar', $menu );
	if ( $search == 'true' ):
	...
	$account = wp_theme_legacy_menu_acf_get( 'customer_account', $menu );
	if ( $account == 'true' ):
	...
	$cart = wp_theme_legacy_menu_acf_get( 'mini_cart', $menu );
	if ( $cart == 'true' ):
	...
	$light_dark = wp_theme_legacy_menu_acf_get( 'light_dark', $menu );
	if ( $light_dark == 'true' ):
	...
	$language = wp_theme_legacy_menu_acf_get( 'language_bar', $menu );
	if ( $language == 'true' ):
